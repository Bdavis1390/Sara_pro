...
- disclosure of credentials, internal security controls, proprietary implementation details, or operational playbooks;
...
- `6.x Evaluation Subject` — dataset, model object, integrated system, or deployment observation;
...
These fields would help prevent a bounded model test from being promoted into a broader system, safety, operational, or certification claim.
