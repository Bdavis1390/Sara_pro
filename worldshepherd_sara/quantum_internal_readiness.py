...
CONTROLS: tuple[InternalControl, ...] = (
    ...
    InternalControl(
        "QRF-DWAVE",
        ("worldshepherd_sara/quantum_dwave.py", "scripts/run_dwave_qubo.py", "requirements-quantum-dwave.txt"),
        ("tests/test_quantum_dwave.py",),
        "credential-gated D-Wave quantum-annealing backend with solver/working-graph, embedding, timing and mission-baseline provenance",
    ),
