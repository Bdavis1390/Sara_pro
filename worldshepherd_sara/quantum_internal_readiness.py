...
CONTROLS: tuple[InternalControl, ...] = (
    ...
    InternalControl("QRF-BRAKET-TASK", ("worldshepherd_sara/quantum_braket_task.py", "scripts/run_braket_qpu_bell.py", "requirements-quantum-braket.txt"), ("tests/test_quantum_braket_task.py",), "credential-safe Amazon Braket on-demand QPU task runner with frozen logical-program identity, provider submission mapping, S3/task/device/result provenance and predeclared-cost claims control"),
